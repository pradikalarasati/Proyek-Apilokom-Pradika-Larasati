...
>plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-001.png}
\begin{eulerprompt}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-006.png}
\begin{euleroutput}
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("x^2-4*x+6",-4,8):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-008.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-009.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-010.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-011.png}
\begin{eulercomment}
...
\begin{eulercomment}
\eulerheading{Menggambar Grafik Fungsi Satu Variabel yang Rumusnya Disimpan dalam}
\begin{eulercomment}
Variabel Ekspresi.
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-013.png}
\begin{eulercomment}
...
\begin{eulercomment}
\eulerheading{Menggambar Grafik Fungsi Satu Variabel yang Fungsinya Didefinisikan}
\begin{eulercomment}
...
>plot2d("-2/3*x^3"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-015.png}
\begin{eulercomment}
...
>plot2d("-2/3*x^(1/3)"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-017.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-018.png}
\begin{euleroutput}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-020.png}
\begin{eulerprompt}
>figure(3,3); ...
>for k=1:9; figure(k); plot2d("x^3-x",-2,1,grid=k); end; ...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-022.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-024.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-025.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-026.png}
\begin{eulerprompt}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-027.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-028.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-029.png}
\begin{eulerprompt}
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-033.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-034.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-040.png}
\begin{eulerprompt}
>for i=1 to 10; plot2d("bin(10,i)*x^i*(1-x)^(10-i)",>add); end;
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerheading{Menggambar Sekumpulan Kurva dengan satu Perintah plot2d.}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-044.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-046.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-050.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-051.png}
\begin{eulercomment}
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-052.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-055.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-056.png}
\begin{eulercomment}
...
>aspect():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-057.png}
\begin{eulerprompt}
>figure(3,4); ...
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-059.png}
\begin{eulerprompt}
>frame; xgrid([-1,0,1]); ygrid(0): // add frame and grid
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-060.png}
\begin{eulercomment}
...
>plot2d("exp(x)",-1,1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-061.png}
\begin{eulerprompt}
>textcolor(black); // set the text color to black
>title(latex("y=e^x")): // title above the plot
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-062.png}
\begin{eulerprompt}
>xlabel(latex("x")): // "x" for x-axis
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-063.png}
\begin{eulerprompt}
>ylabel(latex("y"),>vertical): // vertical "y" for y-axis
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-064.png}
\begin{eulerprompt}
>label(latex("(0,1)"),0,1,color=blue): // label a point
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-065.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-066.png}
\begin{eulerprompt}
>xaxis(0,xx=-2:1,style="->"); yaxis(0,yy=-5:5,style="->"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-067.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-068.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-069.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-070.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-071.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-073.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-075.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-076.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-077.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-078.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-079.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-081.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-083.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-084.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-086.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-088.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-089.png}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-091.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-092.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-095.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-096.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-097.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-098.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-100.png}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-101.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-102.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-103.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-104.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-105.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-106.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-107.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-108.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-109.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-110.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-111.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-112.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-113.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-115.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-116.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-117.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-118.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-121.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-123.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-124.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-125.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-126.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-128.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-129.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-130.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-131.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-132.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-133.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-134.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-136.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-137.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-138.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-139.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-140.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-142.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-144.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-145.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-147.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-148.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-149.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-150.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-151.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-152.png}
...
\end{eulerformula}
\begin{eulerprompt}
> plot2d("sin(x)+sin(2x)",pi,2*pi):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-154.png}
\begin{euleroutput}
...
>a=3; plot2d("f",1,3;a):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-156.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-158.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
f(x)=\frac{1}{4}x^4-x^3-2x^2+3x+4
\]
\end{eulerformula}
\begin{eulerprompt}
>aspect(); plot2d("(1/4)*x^4-x^3-2*x^2+3*x+4",1,5,grid=2,thickness=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-160.png}
\eulersubheading{Contoh-contoh soal}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("x^3-x^2-6*x",-2,3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Pradika Larasati 23030630003_MatB-162.png}
