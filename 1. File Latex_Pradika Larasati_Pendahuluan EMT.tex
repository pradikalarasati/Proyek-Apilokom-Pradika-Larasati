...
\begin{eulerformula}
\[
A=\begin{pmatrix}2 & 1 & 3 \\ 3 & 1 & 2 \\ 2 & 2 & 3 \\ 
 \end{pmatrix}
\]
\end{eulerformula}
\begin{euleroutput}
...
\textbackslash{}lim\_\{x \textbackslash{}to 2\} f(x) = \textbackslash{}frac\{x\textasciicircum{}2+1\}\{5x\}
\end{eulercomment}
\begin{eulerprompt}
>$&limit((x^2+1)/(5*x),x,2)
\end{eulerprompt}
...
F(x) = sin\textasciicircum{}2(x) + 4cos(x)
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  ...
  latex: \(\backslash\)int_1^3 x^3+2x+1
\end{euleroutput}
\begin{eulerprompt}
